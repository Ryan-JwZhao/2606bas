...
def normalize_projection_rotation_degrees(value: object) -> int:
    """Return a supported clockwise projector compatibility rotation."""
...
class ProjectionFrameTransform:
    """Compatibility-only rotation at the final projector-frame boundary."""

    calibration_rotation_degrees: int = 0
    output_rotation_degrees: int = 0
